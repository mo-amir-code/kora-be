    ...
    data: [
      {
        ...
        messageTemplate: "Hi {contact_name}, this is a friendly reminder that payment for {deal_title} is due in 3 days.",
        channelEmail: true,
      ...
      {
        userId,
        name: "Payment Due Tomorrow",
        triggerType: "PAYMENT_DUE",
        offsetValue: 24,
        offsetUnit: "hours",
        nextFollowUps: ["12"],
        recipients: ["primary", "me"],
        messageTemplate: "Hi {contact_name}, payment for {deal_title} is due tomorrow. Please reach out if you have any questions.",
        channelEmail: true,
        channelWhatsapp: false,
        channelPush: true,
        isActive: true,
